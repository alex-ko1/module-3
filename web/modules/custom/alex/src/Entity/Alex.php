...
class Alex extends ContentEntityBase implements ContentEntityInterface {
  ...
  public static function baseFieldDefinitions(EntityTypeInterface $entity_type) {
    ...
    $fields['status'] = BaseFieldDefinition::create('boolean')
      ->setLabel(t('Status'))
      ->setDescription(t('A boolean indicating whether the alex is enabled.'))
    ...
    $fields['description'] = BaseFieldDefinition::create('text_long')
      ...
      ->setDescription(t('A description of the alex.'))
      ->setDisplayOptions('form', [
        'type' => 'text_textarea',
        'weight' => 10,
      ])
    ...
    $fields['uid'] = BaseFieldDefinition::create('entity_reference')
      ->setLabel(t('Author'))
      ->setDescription(t('The user ID of the alex author.'))
